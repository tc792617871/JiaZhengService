...
public class AmountUtils {
	 ...
	 * @throws Exception
	 */
	public static String changeCent2Y(Long amount) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String changeCent2Y(String amount) throws Exception {
	 ...
	 * @return
	 */
	public static String changeY2Cent(Long amount) {
	 ...
	 * @return
	 */
	public static String changeY2Cent(String amount) {
