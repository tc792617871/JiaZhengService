package com.platform.JiaZhengService.common.meta;
...
import com.platform.JiaZhengService.common.util.TypeCaseHelper;
import com.platform.JiaZhengService.common.util.XmlHelper;
...
public class BaseDto extends LinkedHashMap implements Dto, Serializable {
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(JiaZhengServiceConstants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(JiaZhengServiceConstants.XML_Node))
			// 节点元素值风格
