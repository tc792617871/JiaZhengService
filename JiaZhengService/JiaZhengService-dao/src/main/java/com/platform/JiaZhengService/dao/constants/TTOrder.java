...
/**
 * @ClassName: TTOrder
* @Description: t_order表结构对应的常量类，定义字段名常量
* @author: peiyu
 */
public abstract class TTOrder {
    /**
     * @Fields t_order.ID: 
     */
     ...
     */
    public static final String IS_ALLOCATED_STOCK = "is_allocated_stock";
     ...
     */
    public static final String AGREE_RETURN = "agree_return";
     ...
     */
    public static final String PAYMENT_PLUGIN_ID = "payment_plugin_id";

    /**
     * @Fields t_order.CONFIRM_DELIVERY_TIME: 
     */
    public static final String CONFIRM_DELIVERY_TIME = "confirm_delivery_time";
