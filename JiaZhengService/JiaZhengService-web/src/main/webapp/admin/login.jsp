...
<%@page import="com.platform.JiaZhengService.common.pojo.Setting.CaptchaType"%>
<%@page import="com.platform.JiaZhengService.common.pojo.Setting.AccountLockType"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - 家政管理平台</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="xxx Team" />
	...
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.png" alt="Sencloud" />
						</td>
						<th>
				...
				<div class="powered">COPYRIGHT © 2017-2018 EPO ALL RIGHTS RESERVED.</div>
				<div class="link">
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.home")%></a> |
					<a href="http://www.baidu.com.cn"><%=SpringUtils.getMessage("admin.login.contact")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
