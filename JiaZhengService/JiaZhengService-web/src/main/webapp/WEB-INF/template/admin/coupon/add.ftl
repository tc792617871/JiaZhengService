		...
		<div class="tabContent">
			<table class="input">
				...
				<tr style="display: none;">
					...
					<td>
						<input type="text" name="prefix" class="text" maxlength="200" value="JZS"/>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<input type="text" id="circulation" name="circulation" class="text" maxlength="9" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" id="limited" name="limited" class="text" maxlength="9" />
					</td>
				</tr>
			</table>
		</div>
