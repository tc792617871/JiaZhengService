...
$().ready(function() {
	...
	var $tax = $("#tax");
	var $invoiceTypeName = $("#invoiceTypeName");
	var $areaId = $("#areaId");
	...
	$isInvoice.click(function() {
		if ($(this).prop("checked")) {
			...
			$invoiceTypeName.prop("disabled", false);
			
		} else {
			$invoiceTitle.prop("disabled", true);
			$tax.prop("disabled", true);
			$invoiceTypeName.prop("disabled", true);
		}
	});
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<input type="hidden" name="systemType" value="${order.systemType}" />
		<input type="hidden" name="systemVersion" value="${order.systemVersion}" />
		<input type="hidden" name="orderSource" value="${order.orderSource}" />
