		...
		<table class="input">
			...
			<tr class="productGroup">
				...
				<td>
					<ul class="authorities">
						...
						<li>
							<input type="checkbox" name="authorities" id="productExportButton" value="admin:product_button_exportButton" [#if role.authorities?seq_contains("admin:product_button_exportButton")] checked="checked"[/#if] />
						...
						<li>
							<input type="checkbox" name="authorities" id="productConllocation" value="admin:product_a_conllocation" [#if role.authorities?seq_contains("admin:product_a_conllocation")] checked="checked"[/#if] />
							<label for="productConllocation">
								${message("admin.common.conllocation")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="productExportStackOutButton" value="admin:product_button_exportStackOutButton" [#if role.authorities?seq_contains("admin:product_button_exportStackOutButton")] checked="checked"[/#if] />
							<label for="productExportStackOutButton">
								${message("admin.order.productOutOfStock")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="productAdd_OnSale" value="admin:product_icon_add_OnSale"[#if role.authorities?seq_contains("admin:product_icon_add_OnSale")] checked="checked"[/#if]/>
							<label for="productAdd_OnSale">
								${message("+ On sale")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="productDelete_OnSale" value="admin:product_icon_delete_OnSale"[#if role.authorities?seq_contains("admin:product_icon_delete_OnSale")] checked="checked"[/#if]/>
							<label for="productDelete_OnSale">
								${message("- On sale")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="productRefresh_NewArrival" value="admin:product_icon_refresh_NewArrival"[#if role.authorities?seq_contains("admin:product_icon_refresh_NewArrival")] checked="checked"[/#if]/>
							<label for="productRefresh_NewArrival">
								${message("New Arrival")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="productRefresh_BestSeller" value="admin:product_icon_refresh_BestSeller"[#if role.authorities?seq_contains("admin:product_icon_refresh_BestSeller")] checked="checked"[/#if]/>
			...
			<tr class="productGroup">
				<td>
					<ul>
						<li>
							<input type="checkbox" id="consoleSpecification" name="authorities" value="admin:specification" [#if role.authorities?seq_contains("admin:specification")] checked="checked"[/#if]  />
				...
				<td>
					<ul class="authorities">
						...
						<li>
							<input type="checkbox" name="authorities" id="specificationAdd"  value="admin:specification_icon_addIcon" [#if role.authorities?seq_contains("admin:specification_icon_addIcon")] checked="checked"[/#if] />
							<label for="specificationAdd">
								${message("admin.common.add")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="specificationDelete" value="admin:specification_button_deleteButton" [#if role.authorities?seq_contains("admin:specification_button_deleteButton")] checked="checked"[/#if]  />
							<label for="specificationDelete">
								${message("admin.common.delete")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="specificationEdit"  value="admin:specification_a_edit" [#if role.authorities?seq_contains("admin:specification_a_edit")] checked="checked"[/#if] />
							<label for="specificationEdit">
								${message("admin.common.edit")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="specificationSyncSize" value="admin:specification_button_syncSizeButton" [#if role.authorities?seq_contains("admin:specification_button_syncSizeButton")] checked="checked"[/#if] />
							<label for="specificationSyncSize">
								${message("admin.specification.syncSize")}
							</label>
						</li>
						<li>
							<input type="checkbox" name="authorities" id="specificationSyncColor" value="admin:specification_button_syncColorButton" [#if role.authorities?seq_contains("admin:specification_button_syncColorButton")] checked="checked"[/#if] />
