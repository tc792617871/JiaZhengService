...
<title>${message("admin.setting.edit")} - 家政管理平台</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("Setting.defaultPointExchangeScale")}: 
				</th>
				<td>
					<input type="text" name="defaultPointExchangeScale" class="text" value="${setting.defaultPointExchangeScale}" maxlength="7" title="${message("admin.setting.defaultPointExchangeScaleTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				<th>
					${message("Setting.baiduAPI4IPUrl")}: 
				</th>
				<td>
					<input type="text" name="baiduAPI4IPUrl" class="text" value="${setting.baiduAPI4IPUrl}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					${message("Setting.receiptDeadline")}: 
				</th>
				<td>
					<input type="text" name="receiptDeadline" class="text" value="${setting.receiptDeadline}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					${message("Setting.completeDeadline")}: 
				</th>
				<td>
					<input type="text" name="completeDeadline" class="text" value="${setting.completeDeadline}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="checkbox" name="isRefreshStock" value="true" [#if setting.isRefreshStock] checked="checked"[/#if] />
					<input type="hidden" name="_isRefreshStock" value="false" />
				</td>
			</tr>
		</table>
		<table class="input tabContent">
			...
			<tr>
				<th>
					${message("Setting.smsUrl")}:
				</th>
				<td>
					<input type="input" name="smsUrl" class="text" value="${setting.smsUrl}"  maxlength="200"/>
				</td>
			</tr>
			<tr>
				<th>
					${message("Setting.smsAccount")}:
				</th>
				<td>
					<input type="input" name="smsAccount" class="text" value="${setting.smsAccount}"  maxlength="200"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="password" name="smsPassword" class="text" value="${setting.smsPassword}"  maxlength="200"/>
				</td>
			</tr>
		</table>
		<table class="input">
