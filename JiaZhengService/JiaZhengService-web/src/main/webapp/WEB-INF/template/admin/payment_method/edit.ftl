...
<title>${message("admin.paymentMethod.edit")} - 家政服务管理平台</title>
				...
				<td>
					<select name="method">
						[#list methods as method]
							<option value="${method.code}"[#if method.code == paymentMethod.method] selected="selected"[/#if]>${message("PaymentMethod.Method." + method.code)}</option>
						[/#list]
					</select>
				</td>
			</tr>
