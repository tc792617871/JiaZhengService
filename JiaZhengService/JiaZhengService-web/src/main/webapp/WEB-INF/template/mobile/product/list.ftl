...
<body >
	<div class="fullscreen">
		...
		<!-- /header -->
		<!-- <img src="${base}/resources/mobile/images/category_${brand.name}.jpg" alt="${brand.name}" class="index_category" />-->
		<img [#if productColumn] src="${productColumn.columnCoverImage}" alt="${productColumn.nameEn}" [/#if]  class="index_category" />
		<ul class="list_box" id="listBox">
		   <li class="page_loading" id="pageLoading"><div class="loading"><div class="rotate"></div></div></li>
	    </ul>
     <script type="text/javascript">
		var listUrl = "${base}/mobile/listProduct.jhtml?";
