$().ready( function() {
	...
	$exportButton.click( function() {
		...
		$("form").attr("action","select_export.jhtml");
		$listForm.submit();
		$selectAll.prop("checked", false);
		$checkedIds.prop("checked", false);
		$("form").attr("action","list.jhtml");
	});
	...
	$searchExportButton.click( function() {
		...
		$("form").attr("action","search_export.jhtml");
		$listForm.submit();
		$("form").attr("action","list.jhtml");
	});
	//缺货明细导出
	$stockoutExport.click( function() {
		var $this = $(this);
		if ($this.hasClass("disabled")) {
			return false;
		}
		$("form").attr("action","stockout_export.jhtml");
		$listForm.submit();
		$("form").attr("action","list.jhtml");
	});
	//货品销售明细导出
	$productSaleExportButton.click( function() {
		var $this = $(this);
		if ($this.hasClass("disabled")) {
			return false;
		}
		$("form").attr("action","product_sale_export.jhtml");
		$listForm.submit();
		$("form").attr("action","list.jhtml");
	});
