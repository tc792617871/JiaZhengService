(function() {
	var h = {},
		mt = {},
		c = {
			id: "76d2e6ad94d467cbb035e695d1274205",
			dm: ["weixin.res.meizu.com"],
			...
			default:
				...
				if (d instanceof Array) {
					...
					case "unknown":
						break;
					default:
						l && f.push(","), f.push(mt.m.stringify(m)), l = 1
					}
					f.push("]");
					return f.join("")
				}
	...
	(function() {
		...
		function b() {
			...
			if ((!l || !m) && e && k) u = p, r = +new Date;
			else if (l && m && (!e || !k)) u = t, q += +new Date - r;
			l = e;
			m = k;
			x = setTimeout(b, 100)
		}
		...
		function d(a) {
			if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) k = "focus" == a.type || "focusin" == a.type ? p : t, b()
		}
		var g = mt.event,
			n = h.w,
			l = p,
			...
			e = {
				...
				V: function() {
					...
					if (a && a.length) for (var b = 0; b < a.length; b++) {
						...
						case "_setAutoPageview":
							if (1 < d.length && (d = d[1], t === d || p === d)) e.c |= 2, window._bdhm_autoPageview = d
						}
					}
				},
				W: function() {
					if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
						...
						var a = window._hmt;
						if (a && a.length) for (var b = 0, f = a.length; b < f; b++) d.d(a[b], "Array") && "_trackEvent" !== a[b][0] && "_trackRTEvent" !== a[b][0] ? e.D(a[b]) : e.n.push(a[b]);
						window._hmt = e.L
					}
				},
				X: function() {
					if (0 < e.n.length) for (var a = 0, b = e.n.length; a < b; a++) e.D(e.n[a]);
					e.n = s
				},
				D: function(a) {
					if (d.d(a, "Array")) {
				...
				_trackMobConv: function(a) {
					if (a = {
						...
						callback: 5,
						share: 6
					}[a[1]]) e.c |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.j()
				},
				...
				_trackRTEvent: function(b) {
					...
					if (d.d(b, "Object")) {
						...
						else for (var l = Math.ceil(l / 900), r = "block|" + Math.round(Math.random() * n.q).toString(16) + "|" + l + "|", q = [], u = 0; u < l; u++) q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), f.call(this, r + q.join("|")), q = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" == typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = p, this.a = {}, this.B = t, this.init())
		}
		var b = mt.url,
			f = mt.G,
			d = mt.H,
		...
		a.prototype = {
			...
			A: function() {
				for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++) if (this.C(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			J: function() {
			...
			na: function() {
				...
				if (0 === c.nv && this.p(document.location.href) && ("" === document.referrer || this.p(document.referrer))) a = 0, b = 4;
				this.a.nv = a;
				this.a.st = b;
				this.a.cc = d;
				this.a.lt = e;
			...
			init: function() {
				try {
					this.oa(), 0 === this.a.nv ? this.la() : this.F(".*"), h.b = this, this.U(), v.o("pv-b"), this.ka()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);
			...
			la: function() {
				...
				if (b) for (var b = b.split(","), d = function(b) {
						f.log(k.protocol + "//" + decodeURIComponent(b).replace(/^https?:\/\//, ""), function(b) {
							a.F(b)
						})
