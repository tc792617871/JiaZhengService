package com.platform.JiaZhengService.plugin.oss;
...
public class OssController extends AbstractController {
	...
	public @ResponseBody Message uninstall() {
		if (ossPlugin.getIsInstalled()) {
			TPluginConfig pluginConfig = ossPlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/com/platform/JiaZhengService/plugin/oss/setting";
	}
